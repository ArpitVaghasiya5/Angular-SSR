...
describe('ProductTestService', () => {
  ...
  it('should give all products', () => {
    service.getAllProducts().subscribe((allproducts) => {
  ...
  it("should return one item", ()=> {
    ...
    service.getProductById(Id).subscribe((product : any) => {
      expect(product).toBeTruthy();
      expect(product.title).toBe("Essence Mascara Lash Princess")
    })

    const req = httpTesting.expectOne(`https://dummyjson.com/products/${Id}`)
    expect(req.request.method).toEqual("GET");
